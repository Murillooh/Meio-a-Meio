  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 
                 pb-[env(safe-area-inset-bottom)] border-t border-base-line bg-base-card/95 backdrop-blur-xl shadow-2xl
                 md:sticky md:inset-x-auto md:top-0 md:h-screen md:w-[228px] md:shrink-0 md:border-t-0 md:border-r md:bg-base/95 md:pb-0 md:pt-14"
    >
